  ...
  },
  {
    ...
    results: {
      ...
      brainRegions: {
        ...
        positiveRegions: [
          { name: "Mid-Posterior Cingulate Gyrus", hemisphere: "RH", weight: 0.5099, percentage: 10.6, vertices: 12, role: "Posterior cingulate — prediction error monitoring, spatial awareness, detecting unexpected events" },
          ...
          { name: "Medial Orbital-Olfactory Sulcus", hemisphere: "RH", weight: 0.2087, percentage: 4.3, vertices: 1, role: "Ventromedial PFC border — prediction and expectation processing" },
          ...
          { name: "Superior Frontal Gyrus", hemisphere: "RH", weight: 0.1635, percentage: 3.4, vertices: 3, role: "Higher-order planning, temporal prediction of motion trajectories" },
        ...
        negativeRegions: [
          ...
          { name: "Intraparietal Sulcus", hemisphere: "LH", weight: 0.2823, percentage: 5.5, vertices: 3, role: "Dorsal visual stream — spatial attention, object tracking, physics simulation" },
          { name: "Transverse Frontopolar Gyrus", hemisphere: "RH", weight: 0.2279, percentage: 4.5, vertices: 4, role: "Frontopolar cortex — temporal prediction monitoring, forward models" },
          { name: "Supramarginal Gyrus", hemisphere: "LH", weight: 0.1400, percentage: 2.8, vertices: 2, role: "Inferior parietal lobule — action observation, causal reasoning about physics" },
          { name: "Postcentral Gyrus", hemisphere: "LH", weight: 0.1391, percentage: 2.7, vertices: 6, role: "Somatosensory cortex — embodied simulation of physical interactions" },
          { name: "Orbital Gyrus", hemisphere: "RH", weight: 0.1449, percentage: 2.8, vertices: 4, role: "Orbitofrontal cortex — evaluation and physical plausibility assessment" },
        ],
      },
      figures: [
        {
